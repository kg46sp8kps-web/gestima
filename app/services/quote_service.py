...
class QuoteService:
    ...
    async def create_quote_snapshot(quote: Quote, db: AsyncSession) -> Dict[str, Any]:
        ...
        items_data = [
            {
                ...
                "batch_approx": item.batch_approx,
                "notes": item.notes,
            }
            for item in items
        ]
        ...
        snapshot = {
            ...
            "customer_request_number": quote.customer_request_number,
            "request_date": quote.request_date.isoformat() if quote.request_date else None,
            "offer_deadline": quote.offer_deadline.isoformat() if quote.offer_deadline else None,
    ...
    async def clone_quote(
        ...
        new_quote = Quote(
            ...
            customer_request_number=original_quote.customer_request_number,
            request_date=original_quote.request_date,
            offer_deadline=original_quote.offer_deadline,
