...
.action-btn:hover { background: var(--state-hover); }
.action-primary { border-color: var(--brand); color: var(--brand); }
.action-primary:hover:not(:disabled) { background: var(--brand-subtle); }
