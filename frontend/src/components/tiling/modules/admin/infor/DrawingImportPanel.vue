...
<template>
  ...
  <div class="drawing-import-panel">
    ...
    <div class="panel-header">
      ...
      <div class="header-actions">
        <button
          ...
          @click="scanShare"
          data-testid="drawing-scan-btn"
        >
          <Loader2 v-if="scanning" :size="ICON_SIZE_SM" class="spin" />
          <Search v-else :size="ICON_SIZE_SM" />
    ...
    <template v-if="preview">
      ...
      <div class="stats-bar">
        <button
          ...
          data-testid="drawing-filter-all"
        >
        ...
        <button
          ...
          data-testid="drawing-filter-ready"
        >
        ...
        <button
          ...
          data-testid="drawing-filter-imported"
        >
      ...
      <div class="folder-list">
        ...
        <div class="folder-row folder-header">
          <div class="col-check">
            <input
              ...
              data-testid="drawing-select-all"
            />
          </div>
        ...
        >
          ...
          <div class="col-files">
            <FileText :size="ICON_SIZE_SM" v-if="folder.pdf_files.length" />
            {{ folder.pdf_files.length }}
          </div>
          <div class="col-files">
            <Box :size="ICON_SIZE_SM" v-if="folder.step_files.length" />
      ...
      <div class="action-bar">
        ...
        <button
          ...
          @click="executeImport"
          data-testid="drawing-import-btn"
        >
          <Loader2 v-if="importing" :size="ICON_SIZE_SM" class="spin" />
          <Download v-else :size="ICON_SIZE_SM" />
    ...
    <div v-if="result" class="result-bar" :class="result.success ? 'result-ok' : 'result-error'">
      <CheckCircle v-if="result.success" :size="ICON_SIZE" />
      <AlertTriangle v-else :size="ICON_SIZE" />
